...
export default function OrderConfirmation() {
  ...
  useEffect(() => {
    // Get order data from localStorage (in a real app, this would come from your backend)
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>Subtotal</span>
                    <span>${(orderData.total * 0.85).toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Shipping</span>
                    <span>Free</span>
                  ...
                  <div className="flex justify-between text-sm">
                    <span>Tax</span>
                    <span>${(orderData.total * 0.15).toFixed(2)}</span>
                  </div>
                  <Separator />
